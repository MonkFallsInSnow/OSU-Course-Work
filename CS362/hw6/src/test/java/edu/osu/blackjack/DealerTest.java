...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public void testAcceptCard()
	{
		...
		assertEquals("Card was not added to the dealer's hand",card.toString(),d.getHand().get(0).toString());
	}
	...
	public void testAcceptCardNull()
	{
		...
		assertFalse("A null value should not be allowed in the deck",d.getHand().get(0) == null);
	}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	{
		Dealer d = new Dealer();
		Card cardRemoved = d.getDeck().get(0);
		...
		assertTrue("Card should be visible",d.getHand().get(0).isVisible());
	}
	...
	public void testDealCardToPassiveDealer()
	{
		...
		Card cardRemoved = d1.getDeck().get(0);
		...
		assertEquals("Removed card was not added to the passive dealer's hand", cardRemoved.toString(),d2.getHand().get(0).toString());
		assertTrue("Card should be visible",d2.getHand().get(0).isVisible());
	}
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	{
		Dealer d = new Dealer();
		List<Card> originalDeck = d.getDeck();
